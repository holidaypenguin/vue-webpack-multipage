...
// exports.code128 = function (text, { ctx, w, h, fg = "#000000", bg = "#ffffff"}) {
function code128 (text, canvas) {
  ...
  const g = new Graphics(canvas.ctx, width, height, canvas.fg, canvas.bg)
...
function codeValue (chr1, chr2) {
  ...
  return parseInt(String.fromCharCode(chr1) + String.fromCharCode(chr2), 10)
}
...
const Graphics = function (ctx, width, height, fg, bg) {
  this.width = width
  this.height = height
  ...
  this.ctx = isWx ? ctx : ctx.getContext('2d')
  this.fg = fg || '#000000'
  this.bg = bg || '#ffffff'
